...
public:
    ...
    virtual std::vector<double> backprop_inner_product_reuploading(QuantumState* bistate, ParametricQuantumCircuit* param_circuits, std::vector<double> params, UINT num_layers, UINT num_param_in_layer);
    virtual std::vector<double> backprop_with_data(GeneralQuantumOperator* obs, ParametricQuantumCircuit* circuit_with_data);
    virtual std::vector<double> backprop_reuploading(GeneralQuantumOperator* obs, ParametricQuantumCircuit* param_circuit, std::vector<double> params, UINT num_layers, UINT num_param_in_layer);
